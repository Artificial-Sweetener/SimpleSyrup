...
def default_manifest(repo_root: Path) -> AnimaRegressionManifest:
    ...
    focused_tests = (
        "tests/regional_generation/anima/test_anima_module_surface.py",
        "tests/regional_generation/anima/test_anima_lora_weight_categories.py",
        "tests/regional_generation/anima/test_anima_lora_linear.py",
        "tests/regional_generation/anima/test_anima_multi_lora_fidelity.py",
        ...
        "tests/regional_generation/regional/test_regional_lora_conditioning_adapter.py",
        "tests/regional_generation/anima/test_anima_lora_block.py",
        "tests/regional_generation/anima/test_anima_lora_block_inactive_schedule.py",
        "tests/regional_generation/anima/test_anima_projection_batch.py",
        "tests/regional_generation/anima/test_anima_lora_combined_multiplier_cache.py",
        "tests/regional_generation/anima/test_anima_regional_lora_device_cache_lifecycle.py",
        "tests/regional_generation/anima/test_anima_single_adapter_mutations.py",
        "tests/regional_generation/anima/test_anima_regional_lora_target_ownership.py",
        "tests/regional_generation/anima/test_anima_composition_phase.py",
        "tests/regional_generation/anima/test_anima_cross_attention.py",
        "tests/regional_generation/anima/test_anima_self_attention_ownership.py",
        "tests/regional_generation/anima/test_anima_self_attention_coherence.py",
        "tests/regional_generation/anima/test_anima_regional_self_attention.py",
        "tests/regional_generation/anima/test_anima_branch_batch.py",
        "tests/regional_generation/anima/test_anima_query_masks.py",
        "tests/regional_generation/anima/test_anima_query_activity.py",
        ...
        "tests/regional_generation/anima/test_anima_attention_device_cache_lifecycle.py",
        "tests/regional_generation/anima/test_anima_attention_coupling_integration.py",
        "tests/regional_generation/anima/test_anima_tiled_attention_coupling_integration.py",
        "tests/regional_generation/anima/test_anima_contextual_attention_coupling_integration.py",
        "tests/regional_generation/anima/test_anima_regional_lora_admission_results.py",
        "tests/regional_generation/anima/test_anima_regional_lora_performance_manifest.py",
        "tests/regional_generation/anima/test_anima_regional_lora_performance_results.py",
        "tests/regional_generation/anima/test_anima_regional_lora_scaling_results.py",
    )
