"""Construct the exact allocation-free Anima lifecycle fixture."""
...
def meta_anima_model() -> Anima:
    """Return the installed supported Anima architecture on the meta device."""
