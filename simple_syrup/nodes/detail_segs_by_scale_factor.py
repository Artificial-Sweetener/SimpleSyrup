...
"""ComfyUI node declaration for SEGS detailing by scale factor."""
...
from ..services.detail_segs_by_scale_factor_service import (
    DetailSEGSByScaleFactorService,
)
from .scale_factor import scale_factor_options

OPERATION = "Detail SEGS by Scale Factor"


class DetailSEGSByScaleFactor:
    ...
    DESCRIPTION = "Details SEGS regions using crop scale factor sizing."
    SEARCH_ALIASES = ["detailer", "automask", "segs", "scale factor"]

    service_class: ClassVar[type[DetailSEGSByScaleFactorService]] = (
        DetailSEGSByScaleFactorService
    )

    @classmethod
    def INPUT_TYPES(cls) -> dict[str, dict[str, tuple[Any, ...]]]:
        """Declare ComfyUI inputs for scale-factor detailing."""
